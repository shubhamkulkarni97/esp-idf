...
typedef struct {
    ...
    int task_priority;                  /**< priority of the event loop task, ignored if task name is NULL */
 ...
 *  - Others: Fail
 */
esp_err_t esp_event_loop_run(esp_event_loop_handle_t event_loop, int ticks_to_run);
